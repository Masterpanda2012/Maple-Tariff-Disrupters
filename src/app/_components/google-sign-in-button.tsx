...
export function GoogleSignInButton({
  ...
  return (
    <button
      ...
      className="animate-fade-in-up mb-4 flex w-full items-center justify-center gap-2 rounded-xl border border-white/25 bg-white px-4 py-2.5 text-sm font-semibold text-[#1f1f1f] shadow-md transition duration-300 hover:-translate-y-0.5 hover:bg-white/95 disabled:translate-y-0 disabled:opacity-60 motion-reduce:animate-none"
    >

      ...
      <section className="relative w-full overflow-hidden bg-gradient-to-br from-[#1a0a12] via-charcoal to-[#0d1f14] text-white">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-20 sm:py-28">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="animate-fade-in-up text-4xl font-extrabold leading-tight tracking-tight delay-100 sm:text-5xl md:text-6xl">
            ...
            <p className="animate-fade-in-up max-w-2xl text-lg leading-relaxed text-white/85 delay-200">
              Navigate tariffs, trade rules, and currency swings with plain-language
              intelligence for your business — plus a marketplace that connects
              buyers and sellers anywhere you operate.
            </p>
            <div className="animate-pop-in flex flex-col gap-3 delay-300 sm:flex-row sm:flex-wrap motion-reduce:animate-none">
              <Link

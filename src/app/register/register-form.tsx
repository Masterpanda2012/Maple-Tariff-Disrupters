...
export function RegisterForm({
  ...
  return (
    ...
    >
      ...
      <div
        className="mb-6 flex rounded-lg border border-white/20 bg-white/[0.03] p-1"
        role="tablist"
      ...
      >
        <button
          ...
          className={`flex-1 rounded-md px-3 py-2 text-sm font-medium transition duration-300 ${
            roleTab === "business"
              ? "bg-[hsl(280,100%,70%)] text-[#15162c] shadow-sm"
      ...
      {googleAuthEnabled ? (
        ...
        <p className="mb-4 rounded-xl border border-dashed border-white/20 bg-white/[0.06] px-4 py-3 text-center text-xs leading-relaxed text-white/65">
          Google sign-up is off until OAuth credentials are configured. Set{" "}
